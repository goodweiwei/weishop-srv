...
class UserStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreatUser = channel.unary_unary(
                '/User/CreatUser',
                request_serializer=user__pb2.CreatUserInfo.SerializeToString,
                response_deserializer=user__pb2.UserInfoResponse.FromString,
                )
...
def add_UserServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'CreatUser': grpc.unary_unary_rpc_method_handler(
                    servicer.CreatUser,
                    request_deserializer=user__pb2.CreatUserInfo.FromString,
                    response_serializer=user__pb2.UserInfoResponse.SerializeToString,
            ),
...
class User(object):
    ...
    def CreatUser(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/User/CreatUser',
            user__pb2.CreatUserInfo.SerializeToString,
            user__pb2.UserInfoResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
